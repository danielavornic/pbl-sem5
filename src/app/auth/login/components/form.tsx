  ...
  return (
    <div className="min-w-[500px]">
      ...
      <div className="mt-4 flex justify-center">
        <Button className="flex items-center bg-card px-4 py-2 font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2">
